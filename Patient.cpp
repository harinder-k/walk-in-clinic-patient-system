...
bool Patient::operator>(const Patient & rhs) {
    int thisCareCard;
    int rhsCareCard;
    stringstream tcc(this->careCard);
    tcc >> thisCareCard;
    stringstream rcc(rhs.getCareCard());
    rcc >> rhsCareCard;

    if (thisCareCard > rhsCareCard)
		return true;
	else
		return false;
}
...
void Patient::printPatient() {
    cout << this->careCard << ", Patient: " << this->name << ", " << this->address << ", " << this->phone << ", " << this->email << endl;
} // end of operator<<
